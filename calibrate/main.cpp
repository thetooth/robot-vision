...
int main(int argc, char *argv[])
{
    ...
    while (inputVideo.grab())
    {
        ...
        putText(imageCopy, "Press 'c' to add current frame. 'ESC' to finish and calibrate", Point(10, 20),
    ...
    bool saveOk =
        saveCameraParams(outputFile, imageSize, aspectRatio, calibrationFlags, cameraMatrix, distCoeffs, repError);
